        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" className="border-white text-green-700 hover:bg-white/90 h-12 px-6 text-base">
              <MessageSquare className="mr-2 h-5 w-5" /> Live Chat Support
            </Button>
            <Button variant="outline" className="border-white text-blue-900 hover:bg-white/90 h-12 px-6 text-base">
              <Phone className="mr-2 h-5 w-5" /> Call Us Now
            </Button>
          </div>
          <div className="mt-8 text-white/80">
            <p>Follow us on social media for updates, health tips, and more</p>
