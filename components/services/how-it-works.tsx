...
export default function HowItWorks() {
  const steps = [
    ...
    },
    {
      ...
      description: "Sign up with your phone number or email and complete your health profile.",
      color: "bg-green-600",
    },
    {
      number: "03",
    ...
    },
    {
      ...
      description: "Get connected with healthcare providers, book appointments, or access emergency services.",
      color: "bg-teal-600",
    },
  ]
