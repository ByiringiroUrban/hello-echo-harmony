      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Hear from people who have used our appointment booking service.
          </p>
        </div>
            ...
            <div className="md:w-2/3">
              <div className="space-y-3">
                <div className="flex items-center">
                  <p className="w-24 text-sm text-gray-600">5 Stars</p>
                  <div className="flex-1 h-4 bg-gray-200 rounded-full overflow-hidden">
                    <div className="bg-green-600 h-full rounded-full" style={{ width: "85%" }}></div>
                  </div>
                  <p className="w-12 text-right text-sm text-gray-600">85%</p>
                </div>
                <div className="flex items-center">
                  <p className="w-24 text-sm text-gray-600">4 Stars</p>
                  <div className="flex-1 h-4 bg-gray-200 rounded-full overflow-hidden">
                    <div className="bg-green-600 h-full rounded-full" style={{ width: "12%" }}></div>
                  </div>
                  <p className="w-12 text-right text-sm text-gray-600">12%</p>
                </div>
                <div className="flex items-center">
                  <p className="w-24 text-sm text-gray-600">3 Stars</p>
                  <div className="flex-1 h-4 bg-gray-200 rounded-full overflow-hidden">
                    <div className="bg-green-600 h-full rounded-full" style={{ width: "3%" }}></div>
                  </div>
                  <p className="w-12 text-right text-sm text-gray-600">3%</p>
                </div>
                <div className="flex items-center">
                  <p className="w-24 text-sm text-gray-600">2 Stars</p>
                  <div className="flex-1 h-4 bg-gray-200 rounded-full overflow-hidden">
                    <div className="bg-green-600 h-full rounded-full" style={{ width: "0%" }}></div>
                  </div>
                  <p className="w-12 text-right text-sm text-gray-600">0%</p>
                </div>
                <div className="flex items-center">
                  <p className="w-24 text-sm text-gray-600">1 Star</p>
                  <div className="flex-1 h-4 bg-gray-200 rounded-full overflow-hidden">
                    <div className="bg-green-600 h-full rounded-full" style={{ width: "0%" }}></div>
                  </div>
                  <p className="w-12 text-right text-sm text-gray-600">0%</p>
